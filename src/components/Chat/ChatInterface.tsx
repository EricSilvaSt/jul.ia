  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (input.toLowerCase().includes('consulta') || input.toLowerCase().includes('agendar')) {
        ...
        responseText = "Posso ajudá-lo a reagendar. Qual é a data atual do seu compromisso e para quando gostaria de reagendar?";
      } else {
        responseText = "Obrigada pela sua mensagem. Como posso ajudá-lo com seu agendamento hoje?";
      }
