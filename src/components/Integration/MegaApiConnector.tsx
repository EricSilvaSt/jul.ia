...
import { getInstanceStatus, sendWhatsAppMessage } from '../../services/megaApiService';

const MegaApiConnector: React.FC = () => {
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="border rounded-lg p-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <div className="font-mono">julia-teste</div>
            </div>
            <div>
              <span className="text-gray-500">ID Controle:</span>
              <div className="font-mono text-xs">ec0e6a46-c717-4494-9a21-3f7a6433a8a3</div>
            </div>
            <div>
              <span className="text-gray-500">Chave:</span>
              <div className="font-mono">megastart-MZYsnBG1aVs</div>
            </div>
            <div>
              <span className="text-gray-500">Token:</span>
              <div className="font-mono">MZYsnBG1aVs</div>
            </div>
          </div>
        </div>
        ...
        <div className="border rounded-lg p-4 bg-blue-50">
          ...
          <p className="text-sm text-gray-600 mb-2">
            Configure este endpoint no seu painel da Mega-API:
          </p>
          <div className="bg-white p-2 rounded border font-mono text-sm">
            https://seu-dominio.com/api/webhook/mega-api
          </div>
...
export default MegaApiConnector;