...
const createTestClinicData = (clinicId: string): ClinicInfo => {
  return {
    ...
    email: 'contato@redeorto.com.br',
    telefone_contato: '(71) 3336-3030',
    telefone_julia: '(71) 98400-2025',
    cnpj: '34.028.316/0001-23',
    razao_social: 'Redeorto Clínica Odontológica LTDA',
    endereco: 'Av. Tancredo Neves, 620',
    numero: '620',
    complemento: 'Sala 2401 - Ed. Espaço Empresarial',
